        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-wrap justify-center gap-8 max-w-7xl mx-auto">
                ...
                <div class="group relative w-full md:w-[calc(50%-1rem)] lg:w-[calc(33.33%-2rem)] h-96 rounded-2xl overflow-hidden cursor-pointer 
                            glass-card !bg-[#422006]/90 border border-transparent hover:border-gold-500/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(212,175,55,0.15)] hover:-translate-y-2"
                    data-aos="flip-left">
